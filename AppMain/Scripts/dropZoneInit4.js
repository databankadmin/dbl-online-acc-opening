$(function () {
    ...
    var _url = "http://localhost:65410/DropZoneUploader";
    ...
    Dropzone.options.instAuthorisedOfficer3PhotoId = {
        url: _url + "/Single",
        paramName: "_file",
        maxFilesize: 20,//filesize in MB
        autoProcessQueue: true,
        ...
        init: function () {
            this.on("addedfile", function (file) {
                $("#instAuthorisedOfficer3PhotoIdhidden").val(file.name);
                $("#instAuthorisedOfficer3PhotoId").css("border", "2px dashed #0087f7");
            });
            ...
            this.on("removedfile", function (file) {
                if (this.files.length === 0) {
                    $("#instAuthorisedOfficer3PhotoIdhidden").val('');
                    removeFileFromBackend("_instAuthorisedOfficer3PhotoId");
            ...
            this.on("success", function (file, fileName) {
                $("#_instAuthorisedOfficer3PhotoId").val(fileName);
            });
        }
    };


    Dropzone.options.instAuthorisedOfficer4PhotoId = {
        url: _url + "/Single",
        paramName: "_file",
        maxFilesize: 20,//filesize in MB
        autoProcessQueue: true,
        ...
        init: function () {
            this.on("addedfile", function (file) {
                $("#instAuthorisedOfficer4PhotoIdhidden").val(file.name);
                $("#instAuthorisedOfficer4PhotoId").css("border", "2px dashed #0087f7");
            });
            ...
            this.on("removedfile", function (file) {
                if (this.files.length === 0) {
                    $("#instAuthorisedOfficer4PhotoIdhidden").val('');
                    removeFileFromBackend("_instAuthorisedOfficer4PhotoId");
            ...
            this.on("success", function (file, fileName) {
                $("#_instAuthorisedOfficer4PhotoId").val(fileName);
            });
        }
    };


    Dropzone.options.instAuthorisedOfficer5PhotoId = {
        url: _url + "/Single",
        paramName: "_file",
        maxFilesize: 20,//filesize in MB
        autoProcessQueue: true,
        ...
        init: function () {
            this.on("addedfile", function (file) {
                $("#instAuthorisedOfficer5PhotoIdhidden").val(file.name);
                $("#instAuthorisedOfficer5PhotoId").css("border", "2px dashed #0087f7");
            });
            ...
            this.on("removedfile", function (file) {
                if (this.files.length === 0) {
                    $("#instAuthorisedOfficer5PhotoIdhidden").val('');
                    removeFileFromBackend("_instAuthorisedOfficer5PhotoId");
            ...
            this.on("success", function (file, fileName) {
                $("#_instAuthorisedOfficer5PhotoId").val(fileName);
            });
        }
    };
